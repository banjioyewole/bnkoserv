...
app.get('/efarrari',function(req,res){
  ...
  app.get('/now/privacy_policy',function(req,res){
    res.sendFile(path.join(__dirname+'/views/now_privacy_policy.html'));
    //__dirname : It will resolve to your project folder.
  });

  app.get('/lumiboost/privacy_policy',function(req,res){
    res.sendFile(path.join(__dirname+'/views/lumiboost_privacy_policy.html'));
    //__dirname : It will resolve to your project folder.
  });
